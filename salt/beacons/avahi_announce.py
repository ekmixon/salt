...
def __virtual__():
    if HAS_PYAVAHI:
        ...
        return (
            False,
            f"The {__virtualname__} beacon cannot be loaded. The 'python-dbus' dependency is missing.",
        )

    return (
        False,
        f"The {__virtualname__} beacon cannot be loaded. The 'python-avahi' dependency is missing.",
    )
